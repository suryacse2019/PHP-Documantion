...
#$query->insert('suraj_yadav',['name'=>'pushpa','address'=>'puspa@gmail.com']);

// $query->update('suraj_yadav',[
// 	'name'=>'pusparaj Iyyer',
// 	'address'=>'blahblah@gmail.com'
// ])->where('id',35)->commit();


$query->delete('suraj_yadav')->where('id',35)->commit();

echo PHP_EOL;

$query->select('id,name,address')->table('suraj_yadav')->orderBy('id','asc')->limit(5,8)->allrecords();
